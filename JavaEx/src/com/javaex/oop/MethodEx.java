...
public class MethodEx {
	...
	public static void main(String[] args) {
		...
		System.out.println("4 + 5 = " + getSum(4,5)); //매개변수의 순서와 타입이 일치해야 한다
	...
	// 고정 인수, 가변 인수를 같이 쓸 수 있다.
	// -> but 제약: 고정 인수를 먼저 선언, 뒤에 가변인수 선언
	...
	// return 문을 만나면 메서드 실행을 중단하고 호출한 쪽으로 이동
	...
	private static double square(double num) {
		...
		// 반환 타입과 일치하는 데이터를 return 해줘야 한다
		return num * num;
	}
